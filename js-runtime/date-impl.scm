...
;; RFC2822 string.
(define (time->utc-js-string::Js-Base-String t::double)
   (cond
      ((nanfl? t)
       (STR "Invalid Date"))
      (else
...
(define (time->local-string::Js-Base-String t::double dst::double)
   (cond
...
(define (time->date-string::Js-Base-String t::double)
   (cond
      ((nanfl? t) (STR "Invalid Date"))
      (else
...
(define (time->utc-date-string::Js-Base-String t::double)
   (time->date-string t))

(define (time->time-string::Js-Base-String t::double)
   (cond
      ((nanfl? t) (STR "Invalid Date"))
      (else  ;; (format "~a:~a:~a" ...)
...
(define (js-string->time::double s::Js-Base-String)
