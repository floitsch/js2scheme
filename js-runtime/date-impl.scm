...
;; RFC2822 string.
(define (time->utc-js-string::js-string t::double)
   (cond
      ((nanfl? t)
       (STR "Invalid Date"))
      (else
...
(define (time->local-string::js-string t::double dst::double)
   (cond
...
(define (time->date-string::js-string t::double)
   (cond
      ((nanfl? t) (STR "Invalid Date"))
      (else
...
(define (time->utc-date-string::js-string t::double)
   (time->date-string t))

(define (time->time-string::js-string t::double)
   (cond
      ((nanfl? t) (STR "Invalid Date"))
      (else  ;; (format "~a:~a:~a" ...)
...
(define (js-string->time::double s::js-string)
